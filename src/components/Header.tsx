...
export default function Header() {
  return (
    <header className="h-[76px] border-b border-[#ECEEF2] bg-white animate-slideDown">
      <div className="mx-auto flex h-full max-w-[760px] items-center justify-between px-5">
